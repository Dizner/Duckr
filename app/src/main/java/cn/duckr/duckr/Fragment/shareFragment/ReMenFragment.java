...
import cn.duckr.duckr.persenter.ReMen_persenter;
...
public class ReMenFragment extends Fragment implements ReMen_view<Share_local.DataBean> {
    ...
    public void getData() {
        Base_persenter persenter=new ReMen_persenter(this);
