...
//    private static String indexStr="";
    ...
    public Home_modelimpl(Base_persenter persenter) {
        this.persenter = persenter;
    }

    @Override
    public void getData(String ...indexStr) {
        String url="http://api.duckr.cn/api/v6/home/rcmd/list/";
        ...
        x.http().post(entity, new Callback.CacheCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                Gson gson=new Gson();
                Home_HuoDong huoDong = gson.fromJson(result, Home_HuoDong.class);
