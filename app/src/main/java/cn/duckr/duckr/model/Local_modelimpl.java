...
public class Local_modelimpl implements Home_model{


    private Base_persenter persenter;
    public Local_modelimpl(Base_persenter persenter) {
        this.persenter = persenter;
    }

    @Override
    public void getData(String ...indexStr) {
        String url="http://api.duckr.cn/api/v6/local/invite/list/";
