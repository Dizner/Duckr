...
public class Tongcheng_modelimpl implements Home_model {

    private Base_persenter persenter;
    public Tongcheng_modelimpl(Base_persenter persenter) {
        this.persenter = persenter;
    }
    @Override
    public void getData(String... indexStr) {
        String url="http://api.duckr.cn/api/v6/photo/list/local/";
